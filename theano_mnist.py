...
L2_reg=0.0001
n_epochs=50
directory='/Users/taposh/workspace/kaggle/minst'
batch_size=20
n_hidden=500
...
digit_preds = Series(np.concatenate([model_predict(i) for i in range(int(n_test_batches))]))
image_ids = Series(np.arange(1, len(digit_preds) + 1))
submission = DataFrame([image_ids, digit_preds]).T
submission.columns = ['ImageId', 'Label']
submission.to_csv('/Users/taposh/workspace/kaggle/minst/submission_sample1.csv', index=False)
